<template>
    ...
    <main class="w-full flex flex-col items-center pt-[100px]">
        ...
        <section class="w-full flex flex-col flex-wrap centralizado">
            <bilhetes
...
<script setup>
    ...
    consulta.actionsConsultaLoterias({loteria:'duplasena'})
    ...
    function pesquisaConcurso(){
        consultaPorConcurso.actionsConsultaPorConcurso({loteria:'duplasena', concurso:vmodel_concurso.value})
